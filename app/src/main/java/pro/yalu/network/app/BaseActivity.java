...
import static pro.yalu.network.app.AppConfig.auth_key;
import static pro.yalu.network.app.AppConfig.configKey;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void logout() {
        ...
        editor.commit();
        editor.apply();
        startActivity(new Intent(BaseActivity.this, MainActivityYalu.class));
        finishAffinity();
    }
