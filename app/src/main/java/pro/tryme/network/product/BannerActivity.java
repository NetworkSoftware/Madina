            ...
            public void onClick(View view) {
               ...
               /* Uri uri = Uri.parse("smsto:"+"919944555888&text=" + "Hi TRYME MOBILES, I would like buy this "+getIntent().getStringExtra("description")+" product");
                ...
                if (getCallingActivity() != null &&
                        getCallingActivity().getPackageName().equals("pro.tryme.network")) {
                    try {
                        Intent intent = new Intent(Intent.ACTION_VIEW);
                        intent.setData(Uri.parse("http://api.whatsapp.com/send?phone=919715439506"
                                + "&text=" + "Hi TRYME MOBILES, I would like buy this *" + getIntent().getStringExtra("description") + "* product"));
