package pro.network.madina.cart;
...
import pro.network.madina.orders.MyOrderListAdapter;
import pro.network.madina.orders.MyorderBean;
...
import static pro.network.madina.app.AppConfig.ORDER_CREATE;
...
public class CartActivity extends BaseActivity implements CartItemClick {
    ...
    private void showAddressPopup() {
        ...
        title.setText("Do you want to confirm this order? If yes Order will be Placed and MADINA admin will contact you shortly.");
