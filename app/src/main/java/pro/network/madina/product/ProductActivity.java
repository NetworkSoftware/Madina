...
public class ProductActivity extends BaseActivity implements ViewClick {
    ...
    private TextView basketCount, createdon;
    ...
    protected void startDemo() {
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("tel:6374864026"));
        ...
        chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    intent.setData(Uri.parse("http://api.whatsapp.com/send?phone=916374864026"
                            + "&text=" + "Hi MADINA, I would like buy this *" + product_name.getText().toString() + "* product"));
        ...
        db = new DatabaseHelperMadina(this);
       ...
       basketCount = findViewById(R.id.cartImgBadge);
        ...
        if( attachmentBaseAdapter.getItemCount()<0) {
        baseList.setVisibility(View.GONE);
        }


        getSupportActionBar().setTitle(productBean.getModel());
        getSupportActionBar().setSubtitle(getString(R.string.app_name_home));
                ...
                if (ContextCompat.checkSelfPermission(ProductActivity.this,
                    ...
                    if (bitmap != null) {
                        ...
                        intent.putExtra(Intent.EXTRA_TEXT, productBean.getBrand() +
                                " " + productBean.getModel() + "\nVisit more products like this\nhttps://play.google.com/store/apps/details?id=pro.madina.network");
